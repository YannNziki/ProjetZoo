...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="style_enregistrer_e.css">
    <meta charset="UTF-8">
...
<body>
    ...
    <center><h1>Employé</h1></center>
            ...
            <form action="new_user.php" method="post">
                ...
                Fonction : <select name="fonctions" class="style2"><option value ="employe">Employe</select> <br>
